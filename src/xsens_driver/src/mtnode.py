    ...
    def spin_once(self):
        ...
        if acc_data:
            if 'Delta v.x' in acc_data: # found delta-v's
                ...
                imu_msg.linear_acceleration_covariance[4] = self.covar_acc
                imu_msg.linear_acceleration_covariance[8] = self.covar_acc
            else:
        ...
        if gyr_data:
            if 'Delta q0' in gyr_data: # found delta-q's
                ...
                imu_msg.angular_velocity_covariance[4] = self.covar_gyro
                imu_msg.angular_velocity_covariance[8] = self.covar_gyro
            else:
        ...
        if orient_data:
            if 'Q0' in orient_data:
                ...
                imu_msg.orientation_covariance[4] = self.covar_orien
                imu_msg.orientation_covariance[8] = self.covar_orien
